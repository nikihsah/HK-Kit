...
CATEGORY_HINTS = [
    ...
    ("combat-rules", ["__combat_section_page_range_only__"]),
    ("travel-rest-rules", ["__travel_rest_section_page_range_only__"]),
...
PAGE_CATEGORY_HINTS = [
    ...
    },
    {
        "page_start": 48,
        "page_end": 48,
        "category_hint": "advancement",
        "reason": "advancement_section_page_range",
    },
    {
        "page_start": 49,
        "page_end": 57,
        "category_hint": "combat-arts",
        "reason": "combat_arts_section_page_range",
    },
    {
        "page_start": 58,
        "page_end": 73,
        "category_hint": "magic",
        "reason": "magic_section_page_range",
    },
    {
        "page_start": 74,
        "page_end": 87,
    ...
    },
    {
        "page_start": 117,
        "page_end": 122,
        "category_hint": "combat-rules",
        "reason": "combat_rules_section_page_range",
    },
    {
        "page_start": 123,
        "page_end": 124,
        "category_hint": "travel-rest-rules",
        "reason": "travel_rest_rules_section_page_range",
    },
]
...
def build_candidates(layer0: dict[str, Any], min_chars: int = 40) -> dict[str, Any]:
    ...
    for page in pages:
        ...
        blocks = (
            ...
            if page_hint in {"paths", "skills", "advancement", "combat-arts", "magic", "charms", "equipment", "combat-rules", "travel-rest-rules"}
